...
- (void)setDelegateWithDelegate:(id <ChatViewDelegate> _Nonnull)delegate;
- (void)layoutSubviews;
...
SWIFT_PROTOCOL("_TtP5IMSdk16ChatViewDelegate_")
...
@interface TMImageBrowserView (SWIFT_EXTENSION(IMSdk)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
